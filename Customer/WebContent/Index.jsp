			...
			<h1>Customer Registration</h1>
				<form id="formCustomer" name="formCustomer" method="post" action="Index.jsp">  
					...
					<br>Address:   
  					...
  					<br>Email:   
  					<input id="cusEmail" name="cusEmail" type="text"  class="form-control form-control-sm">
					<br>Phone No:   
  					<input id="cusPhone" name="cusPhone" type="text"  class="form-control form-control-sm">
					<br>  
